...
5. Modern Interpretability ([slides](https://github.com/Madjakul/AdvancedNLP/raw/main/slides/pdf/course4_efficiency.pdf) / [lab session](https://arena-chapter1-transformer-interp.streamlit.app/[1.4.1]_Indirect_Object_Identification))
